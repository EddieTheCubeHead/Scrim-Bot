...
j‰rjest‰miseen discord-serverin k‰ytt‰jien kesken. botti luo '/scrim (peli)'
...
Botissa on sis‰‰nrakennettuna mahdollisuus yhdell‰ komennolla luoda serverille
roolij‰rjestelm‰ sis‰isen pelilistan pohjalta. "/setup_roles" -komento, joka on
k‰ytˆss‰ vain serverin admin-k‰ytt‰jille luo roolin ja emojin jokaiselle botin
tukemalle pelille, mik‰li serverill‰ ei jo ole sellaista, ja k‰ytt‰j‰n halutessa
luo viel‰ uuden kategorian ja kanavan automoidulle roolinasetukselle. T‰ll‰ kanavalla
on vain botin luoma embed-viesti, johon botti alustaa kaikki peliemojit reaktiona
ja k‰ytt‰j‰t voivat lis‰t‰ ja poistaa itselt‰‰n rooleja lis‰‰m‰ll‰ ja poistamalla
vastaavan pelin reaktioita. Kaikki ei-bottik‰ytt‰jien viestit kyseisell‰ kanavalla
...
###############################################################################
  ...
  1.0.0 -- 02.02.2020
    ...
    -Koulutˆiden vuoksi projekti sivuroolissia pitk‰n aikaa, suuria muutoksia ei
	ole tehty, mutta k‰ytˆn myˆt‰ ilmenneit‰ bugeja korjattu tarpeeksi, jotta
	botti tuntuu vakaalta ja valmiilta.
		-Tiimien muokkaus uudelleenkirjoitettava 1.1.0: t‰ll‰ hetkell‰ botti voi
		menn‰ jumiin, jos suorituksessa tulee ongelma kesken tiimien muokkauksen, j‰tt‰en
		puolivalmiita listoja muuttujiin ja pakottaen uudelleenk‰ynnistyksen
		muuttujien tyhjent‰miseksi.
	-Pieni‰ k‰ytett‰vyysparannuksia ja pohjakoodi asetukset-systeemille (1.2.0?)
		-Aktiivinen scrim est‰‰ viestin l‰hett‰misen kanavalle
		-/note t‰m‰ kiert‰miseksi
		-Lukitsemattomat scrimit terminoidaan viidentoista minuutin j‰lkeen. Ajastin
		uudelleenk‰ynnistet‰‰n kaikissa interaktioissa
